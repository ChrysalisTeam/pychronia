...
Use the runner.py script of rpgweb package to reset test DBs, pack persistent ZODB, and run django dev server against persistent DBs
...
Sources Tree Overview for rpgweb package
==========================================
...
Summary of HTTP request processing in rpgweb
==============================================
