...
inner_game_urlpatterns = patterns('pychronia_game.views',
                                  ...
                                  url(r'^MEDIA_TEST/$', 'MEDIA_TEST'),
                                  # to check that all audio/video formats are well read by web browser!
                                  ...
                                  url(r'^enigma_runes_cards/$', 'enigma_runes_cards'),

                                  url(r'^auction_items/$', 'auction_items_slideshow'),
                                  url(r'^personal_items/$', 'personal_items_slideshow'),

                                  url(r'^item3dview/(?P<item>.*)/$', 'item_3d_view'),
                                  # Beware: slideshow URLs must not contain underscores, else 3D images are flashing !
                                  ...
                                  url(r'^messages/ajax_set_dispatched_message_state_flags/$',
                                      'ajax_set_dispatched_message_state_flags'),
                                  url(r'^messages/ajax_set_message_template_state_flags/$',
                                      'ajax_set_message_template_state_flags'),
                                  ...
                                  url(r'^messages/ajax_permanently_delete_message/$',
                                      'ajax_permanently_delete_message'),
                                  ...
                                  url(r'^ability/my_runic_translation_open/$', 'runic_translation_open'),
...
support_urlpatterns = patterns('',
                               ...
                               url(r'^%s(?P<hash>[^/]+)/(?P<path>.+)$' % config.GAME_FILES_URL[1:],
                                   'pychronia_game.views.serve_game_file'),  # NOT a gameview
...
game_admin_urlpatterns = patterns('pychronia_game.meta_administration_views',
                                  ...
                                  (r'^administration/edit/(?P<target_instance_id>[^/]+)/$', "edit_instance_db"),
                                  # NOT game_instance_id, else bug with middleware
                                  )
