...
class WiretappingAbility(AbstractAbility):
    ...
    GAME_ACTIONS = dict(targets_form=dict(title=ugettext_lazy("Choose wiretapping targets"),
                        ...
                        purchase_confidentiality_protection=dict(
                            title=ugettext_lazy("Purchase confidentiality protection"),
    ...
    def _get_admin_summary_html(self):
        ...
        for username in usernames:
            ...
            data = dict(has_confidentiality_activated=has_confidentiality_activated,
                        ...
                        broken_wiretapping_targets=list(
                            self.determine_broken_wiretapping_data(username=username).keys()), )
    ...
    def get_template_vars(self, previous_form_data=None):
        ...
        # might be None if no personal permissions
